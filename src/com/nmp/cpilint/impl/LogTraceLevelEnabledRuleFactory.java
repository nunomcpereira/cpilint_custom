...
public final class LogTraceLevelEnabledRuleFactory implements RuleFactory {

	@Override
	public boolean canCreateFrom(Element e) {
		return e.getName().equals("log-trace-level-enabled-rule");
	}
	...
	public Rule createFrom(Element e) {
		...
		return new LogTraceLevelEnabledRule(exclusions);
	}

...
public final class DisallowedExpressionsRuleFactory implements RuleFactory {

	@Override
	public boolean canCreateFrom(Element e) {
		return e.getName().equals("disallowed-expressions");
	}
	...
	public Rule createFrom(Element e) {
		...
		return new DisallowedExpressionsRule(disallowedExpressions);
	}

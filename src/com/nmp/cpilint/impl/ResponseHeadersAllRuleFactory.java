...
public final class ResponseHeadersAllRuleFactory implements RuleFactory {

	@Override
	public boolean canCreateFrom(Element e) {
		return e.getName().equals("response-headers-allowed");
	}
	...
	public Rule createFrom(Element e) {
		...
		return new ResponseHeadersAllRule(exclusions, inclusions);
	}
